...
#Processing outgroup
Number_of_fastas_out = fastasplit(r'C:\Users\chapmanvl\Documents\VC 2019 projects\outgroup\sequence.fasta', 'outgroup')
details_out = multiple_seq_to_ps_file(r'C:\Users\chapmanvl\Documents\VC 2019 projects\outgroup\outgroup', 'power_signals')
folder_out = r'C:\Users\chapmanvl\Documents\VC 2019 projects\outgroup\outgroup\power_signals'
even_signals_out = even_scale_multi(folder_out, scaling_factor)
...
unjoined = [even_signals, even_signals_out]

labelled = pd.concat(unjoined, axis = 1)
labelled = labelled.T
labelled['colour'] = 0
# outgroup remains as 0
labelled.loc[black, 'colour'] = 0.25
labelled.loc[blue, 'colour'] = 0.50
labelled.loc[green, 'colour'] = 0.75
labelled.loc[purple, 'colour'] = 1.00
labelled.loc[red, 'colour'] = 1.25
labelled.tail()
...
for i in range(14):
    ...
    outgroupnum.append(join(f'outgroup{i}'))
...
colnames.extend(outgroupnum[1:14])
labelled.index = colnames

# Pickling final dataframe
with open(r'C:\Users\chapmanvl\Documents\VC 2019 projects\Influenza A segment 6 NA\even_scaled_signals_labelled.txt', 'wb') as file:
        pickle.dump(labelled, file)
